...
if __name__=='__main__':
    ...
    #post_A1,post_B1,post_pi1=Minibatch_Gibbs(data,I,A,B,pi,5000,80,hidden_state,obs_state,p)
    post_A,post_B,post_pi=Naive_Minibatch_Gibbs(data, I, A, B, pi, 5000, 80, hidden_state, obs_state, p)